            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-xs text-gray-300 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  ...
                  <p>We collect and process your personal data to provide our job matching services. Your data is never sold to third parties. You may request deletion of your data at any time by contacting us.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-xs text-gray-300 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  ...
                  <p>By using JobPortal you agree to our terms. You must be 18+ to register. Employers are responsible for the accuracy of job listings. We reserve the right to suspend accounts that violate our community guidelines.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-xs text-gray-300 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  ...
                  <p>We use essential cookies to keep you logged in and remember your preferences. Analytics cookies help us improve the platform. You can manage or disable non-essential cookies in your browser settings at any time.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <Link
              ...
              >
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-xs text-gray-300 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  ...
                  <p>Have questions or feedback? Reach us at support@jobportal.com or use the contact form. Our team typically responds within 1–2 business days.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </Link>
            </div>
